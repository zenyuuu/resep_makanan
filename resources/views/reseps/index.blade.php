<x-app-layout>
    <div class="container py-4">
        ...
        <div class="mb-4">
            <form action="{{ route('reseps.index') }}" method="GET" class="d-flex align-items-center">
                <input type="text" name="search" class="form-control me-2" placeholder="Cari resep..." value="{{ request('search') }}">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto d-flex justify-content-between align-items-center">
                                ...
                                @auth
                                    <form action="{{ route('reseps.favorite', $resep) }}" method="POST" class="d-inline">
                                        @csrf
                                        <button type="submit" class="btn btn-sm btn-favorite {{ $resep->isFavoritedBy(auth()->user()) ? 'favorited' : '' }}">
