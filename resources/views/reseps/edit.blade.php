...
<div class="edit-resep-wrapper">
    <div class="edit-resep-card">
        <!-- Header -->
        <div class="edit-resep-header">
            <h1><i class="fas fa-edit"></i> Edit Resep</h1>
            <p>{{ $resep->judul }}</p>
        </div>

        <!-- Body -->
        <div class="edit-resep-body">
            @if ($errors->any())
            ...
            <form action="{{ route('reseps.update', $resep->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group-wrapper">
                    ...
                    <textarea class="form-control" id="bahan" name="bahan" required>{{ old('bahan', $resep->bahan) }}</textarea>
                </div>
                ...
                <div class="form-group-wrapper">
                    ...
                    <textarea class="form-control" id="langkah" name="langkah" required>{{ old('langkah', $resep->langkah) }}</textarea>
                </div>
